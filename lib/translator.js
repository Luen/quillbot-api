...
async function translator(text, options = {}) {
    ...
    try {
        ...
        // Since text is in URL, translation should happen automatically
        // Wait for page to fully load and translation to complete
        console.log('Text included in URL - waiting for automatic translation...');
        await saveHTMLForDebug(page, 'translator-before-translation.html', isDev);

        try {
            // Wait for translation to complete (text in URL should trigger auto-translation)
